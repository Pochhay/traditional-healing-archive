...
const styles = {
  ...
  chip: {
    fontSize: 12, color: "#86B29B", textDecoration: "none", padding: "4px 10px",
...
export default function AuthNav() {
  ...
  const hoverProps = (id, base) => ({
    ...
    style: { ...base, color: hover === id ? "#DBE5DE" : undefined },
  });
    ...
    <nav style={styles.nav}>
      {email ? (
        ...
        <>
          ...
          <Link href="/signup" {...hoverProps("signup", styles.chip)}>Sign up</Link>
        </>
      )}
    </nav>
  );
